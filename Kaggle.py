...
# Định nghĩa kích thước hình ảnh đầu vào
...
bestWeightModelEvaluate(model=model, weight_path=checkpoint_path, data=test_data)

bestWeightModelEvaluate(model=model, weight_path=checkpoint_path, data=valid_data)
